    ...
    <GlassCard className="group p-6 lg:p-7">
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-4">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#d33568]/15 border border-[#d33568]/20 shadow-[0_0_30px_rgba(220,47,101,0.35)]">
        ...
        <div className="mt-6 inline-flex rounded-full border border-[#d33568]/20 bg-[#d33568]/10 px-4 py-2 text-sm text-[#ff6f9d] backdrop-blur-xl">
          {card.badge}
        </div>
      </div>
    </GlassCard>
...
function ApiCard({ title }: { title: string }) {
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-[#d33568]/15 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100" />

      <div className="relative z-10 flex items-start gap-3">
        <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#d33568]/15 border border-[#d33568]/20">
      ...
      <div className="space-y-5">
        {stats.map((item) => {
          ...
          return (
            ...
            >
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-[#d33568]/20 bg-[#d33568]/12 shadow-[0_0_30px_rgba(220,47,101,0.25)]">
...
export default function WhiteBooksHero() {
  return (
    <section className="relative overflow-hidden bg-[#050816] py-20 text-white lg:min-h-screen lg:py-28">
      ...
      <div className="absolute left-1/2 top-1/2 h-[900px] w-[900px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-dashed border-[#d33568]/10" />

      <div className="absolute left-1/2 top-1/2 h-[1200px] w-[1200px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-dashed border-[#d33568]/5" />
      ...
      <div className="relative z-10 mx-auto max-w-[1500px] px-5 sm:px-8 lg:px-10">
        ...
        >
          <div className="inline-flex items-center gap-4 rounded-3xl border border-white/10 bg-white/[0.04] px-6 py-4 backdrop-blur-2xl">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#ff5a8e] to-[#d33568] shadow-[0_0_40px_rgba(220,47,101,0.45)]">
          ...
          <h1 className="mx-auto mt-10 max-w-5xl text-balance text-[42px] font-black leading-[1.02] sm:text-[56px] lg:text-[86px]">
            <span className="bg-gradient-to-r from-[#ff78a5] via-[#ff4e87] to-[#d33568] bg-clip-text text-transparent">
        ...
        <div className="relative mt-16 grid gap-8 xl:grid-cols-[320px_1fr_320px]">
          ...
          >
            ...
            <GlassCard className="p-6">
              <div className="flex items-center gap-4">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-[#d33568]/20 bg-[#d33568]/10">
          ...
          >
            ...
            <div className="relative mx-auto my-10 flex max-w-[420px] items-center justify-center">
              {/* Glow */}
              <div className="absolute inset-0 rounded-full bg-[#d33568]/25 blur-[120px]" />
              ...
              <motion.div
                ...
                className="absolute h-[500px] w-[500px] rounded-full border border-dashed border-[#d33568]/15"
              />
