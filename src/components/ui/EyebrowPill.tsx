...
export function EyebrowPill({ label, subtitle }: EyebrowPillProps) {
  return (
    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[rgba(220,47,101,0.10)] text-[#dc2f65] [font-family:var(--font-mono)] text-xs font-semibold uppercase tracking-[0.14em]">
