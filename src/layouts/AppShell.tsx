...
const FONT_PAIRS: Record<FontPairKey, FontPair> = {
  syne_dmsans: { serif: "'Syne', 'Helvetica Neue', Helvetica, Arial, sans-serif", sans: "'DM Sans', ui-sans-serif, sans-serif" },
...
const FONT_PAIR_LABELS: Record<FontPairKey, string> = {
  syne_dmsans: 'Syne + DM Sans (Homepage)',
...
export function AppShell(): React.ReactElement {
  ...
  const pair = FONT_PAIRS[t.fontPair] ?? FONT_PAIRS.syne_dmsans;
